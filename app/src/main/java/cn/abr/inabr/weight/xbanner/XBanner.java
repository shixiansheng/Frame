package cn.abr.inabr.weight.xbanner;
...
import cn.abr.inabr.weight.xbanner.transformers.BasePageTransformer;
import cn.abr.inabr.weight.xbanner.transformers.Transformer;
...
public class XBanner extends RelativeLayout implements XBannerViewPager.AutoPlayDelegate, ViewPager.OnPageChangeListener {
    ...
    private static final int RMP = LinearLayout.LayoutParams.MATCH_PARENT;
    private static final int RWC = LinearLayout.LayoutParams.WRAP_CONTENT;
    ...
    private void initView(Context context) {
        ...
        //设置指示器背景容器
        LinearLayout pointContainerRl = new LinearLayout(context);
        ...
        if (mIsNumberIndicator) {
            ...
            pointContainerRl.addView(mPointRealContainerLl, params);
        }
